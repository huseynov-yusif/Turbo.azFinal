    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SpeedBoxs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpeedBoxId = table.Column<int>(type: "int", nullable: false),
                    ...
                    EngineStrong = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Announcements_Currencys_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Announcements_Distances_DistanceId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Announcements_Seats_SeatId",
                        column: x => x.SeatId,
                        principalTable: "Seats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Announcements_SpeedBoxs_SpeedBoxId",
                        column: x => x.SpeedBoxId,
                        principalTable: "SpeedBoxs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "AnnouncementSpesificationItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnnouncementSpesificationItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnnouncementSpesificationItems_Announcements_AnnouncementId",
                        column: x => x.AnnouncementId,
                        principalTable: "Announcements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AnnouncementSpesificationItems_Spesifications_SpesificationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_DistanceId",
                table: "Announcements",
                column: "DistanceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_SeatId",
                table: "Announcements",
                column: "SeatId");

            migrationBuilder.CreateIndex(
                name: "IX_Announcements_SpeedBoxId",
                table: "Announcements",
                column: "SpeedBoxId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementSpesificationItems_AnnouncementId",
                table: "AnnouncementSpesificationItems",
                column: "AnnouncementId");

            migrationBuilder.CreateIndex(
                name: "IX_AnnouncementSpesificationItems_SpesificationId",
                table: "AnnouncementSpesificationItems",
